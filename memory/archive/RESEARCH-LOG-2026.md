# Archived Research Log — 2026

Cold history rotated losslessly from `memory/RESEARCH-LOG.md`. Routine reads must use `scripts/memory_log.py`; this file is for audit lookup.
